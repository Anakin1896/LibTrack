...
function AdminDashboard({ user }) {
  ...
  const handlePrintInventory = (e) => {
    ...
    iframe.contentDocument.write(`
      <html>
        <head>
          <title>LibTrack - Inventory Report</title>
          <style>
            body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 40px; color: #333; }
            .header { text-align: center; border-bottom: 2px solid #14291c; padding-bottom: 20px; margin-bottom: 30px; }
            .header h1 { margin: 0; color: #14291c; font-size: 24px; }
            .header h2 { margin: 5px 0; color: #555; font-size: 18px; font-weight: normal; }
        ...
        <body>
          <div class="header">
            ...
            <h2>Library Inventory Status Report</h2>
          </div>
          <div class="meta">
            ...
            <strong>Total Titles:</strong> ${books.length}
          </div>
          <table>
            <thead>
              <tr><th>ISBN</th><th>Title</th><th>Author</th><th>Total Copies</th><th>Available</th></tr>
            </thead>
            <tbody>
              ${books.map(b => `
                <tr>
  ...
  const handlePrintBorrowingLog = (e) => {
    e.preventDefault();
    const iframe = document.createElement('iframe');
    iframe.style.display = 'none';
    document.body.appendChild(iframe);
    ...
    iframe.contentDocument.write(`
      <html>
        <head>
          <title>LibTrack - Borrowing Log</title>
          <style>
            body { font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; padding: 40px; color: #333; }
            .header { text-align: center; border-bottom: 2px solid #14291c; padding-bottom: 20px; margin-bottom: 30px; }
            .header h1 { margin: 0; color: #14291c; font-size: 24px; }
        ...
        <body>
          <div class="header">
            <h1>Jose Panganiban National High School (JPNHS)</h1>
            <h2>Library Circulation & Borrowing Log</h2>
          </div>
          <div class="meta">
            <strong>Generated By:</strong> ${user?.first_name} ${user?.last_name} (${user?.role})<br/>
            <strong>Date Generated:</strong> ${new Date().toLocaleString()}<br/>
            <strong>Total Recorded Transactions:</strong> ${transactions.length}
          </div>
          <table>
            <thead>
              <tr><th>Borrower ID</th><th>Book Title</th><th>Due Date</th><th>Return Date</th><th>Status</th></tr>
            </thead>
            <tbody>
              ${transactions.map(tx => `
                <tr>
                 ...
                 <div className="space-y-8">
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-stone-100 p-6">
                      ...
                      <div className="grid grid-cols-2 gap-3 border-t border-stone-100 pt-3">
                         <button type="button" onClick={handlePrintInventory} className="py-4 bg-stone-50 hover:bg-stone-100 border border-stone-200 rounded-xl flex flex-col items-center justify-center gap-1 transition-colors">
                           <span className="text-xl text-emerald-600">🖨️</span>
                           <span className="text-[10px] font-bold text-slate-700 uppercase">Print Inventory</span>
                         </button>
                         <button type="button" onClick={handlePrintBorrowingLog} className="py-4 bg-stone-50 hover:bg-stone-100 border border-stone-200 rounded-xl flex flex-col items-center justify-center gap-1 transition-colors">
                           <span className="text-xl text-purple-600">🖨️</span>
                           <span className="text-[10px] font-bold text-slate-700 uppercase">Print Logs</span>
                         </button>
                      </div>
                    </div>
